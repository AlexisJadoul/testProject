...
const { createOfferSchema, editOfferSchema, editPasswordSchema } = require('../validation/schemas');
...
router
    .route('/edit')
    .patch(validate('body', editOfferSchema), jwt.getAuthTokken, controllersHandler(profileController.update));
